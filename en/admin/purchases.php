...
<div class="container-fluid">
    ...
    <!-- NAV -->
    <?php include 'nav.php'; ?>
               <a href="purchases.php"> <img src="../../base_de_datos/Ingles.jpg" class="redondo" width=60 height=30/></a>
            <a href="../../en/admin/purchases.php"> <img src="../../base_de_datos/descarga" class="redondo"  width="60" height="30"/> </a>
    <!-- /NAV -->
        <h1 class="text-center">List of buy´s</h1>
        <br>
<?php
session_start();
...
?>
        ...
        <table class="table table-striped">
            <thead><tr><td>ID</td><td>Client</td><td>Flight</td><td>Seats</td><td>Estate</td><td>Justification</td></tr></thead><tbody>          
<?php
...
{
    echo "<p class='text-danger text-center'>Error: The database is empy</p>";
}
?>
        </tbody></table>
        </div>    
