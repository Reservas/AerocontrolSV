...
include "../files/conexion.php";
        ...
        $stmt->bind_result($bookid,$id,$seat,$departure_time,$cost,$seats,$description,$arrival_city,$arrival_time,$arrival_runway,$aircraft,$airline);
         while ($stmt->fetch()) {
                ...
                $resta = $date->diff($now)->format("%h hour, %i minutes & %s second");
                ...
                echo "<div class='modal-dialog'>
                    <div class='modal-content'>
                      ...
                      <div class='form-group ' style='margin-left:4%;margin-right:4%;'>
						  ...
						  <textarea  name='justification' maxlength='512' placeholder='Enter the justification' class='form-control' required='required' />
						  <input type='hidden' name='bookid' value='$bookid' />
                        </div>
                      <div class='modal-footer'>
                        
                        <button  name='cancelar' type='submit' class='btn btn-danger'>Cancel your flight</button>
                        </form>
                      </div>
                    </div>
                  </div>";
