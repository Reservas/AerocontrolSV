<html>
  ...
  <strong>ERROR!</strong> <a href='./ajax/loadmidal.php' class='alert-link'>We do not have too many seats dispobibles.
</div>";
                }
                
            }
        ?>
        <a href="reserva.php"> <img src="../../base_de_datos/Ingles.jpg" class="redondo" width=60 height=30/></a>
        <a href="../../es/user/reserva.php"> <img src="../../base_de_datos/descarga" class="redondo"  width="60" height="30"/> </a>
        <div class="col-xs-12">
